...
default_values = {'AUTO_DELETE_MESSAGE_DURATION': 60,
                  ...
                  'IMAGE_URL': 'https://telegra.ph/file/086ed00c5b975595d0eb4.jpg',
...
def load_config():
    ...
    SERVER_PORT = 69 if len(SERVER_PORT) == 0 else int(SERVER_PORT)
    ...
    if len(GD_INFO) == 0:   
        GD_INFO = 'Uploaded by Killerlearner Mirror Bot'
    ...
    if len(IMAGE_URL) == 0:
        IMAGE_URL = '0https://telegra.ph/file/086ed00c5b975595d0eb4.jpg'
