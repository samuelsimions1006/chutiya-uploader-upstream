...
<body>
  <!--© Designed and coded by @killerlearner-->
    <header>
      <div class="brand">
        <img
          src="https://graph.org/file/1a6ad157f55bc42b548df.pn"
          alt="logo"
        />
        <a href="https://t.me/killerlearner">
          <h2 class="name">Qbittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/killerlearner"><i class="fab fa-github"></i></a>
        <a href="https://t.me/killerlearner"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://graph.org/file/1a6ad157f55bc42b548df.pn" type="image/jpg">
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link
      href="https://fonts.googleapis.com/css2?family=Ubuntu:ital,wght@0,300;0,400;0,500;0,700;1,300;1,400;1,500;1,700&display=swap"
...
@app.route('/')
def homepage():
    return "<h1>You are not authorised! <a href='https://killerlearner.t.me'>@Owner</a> By <a href='https://github.com/killerlearners'>For killerlearners</a></h1>"
